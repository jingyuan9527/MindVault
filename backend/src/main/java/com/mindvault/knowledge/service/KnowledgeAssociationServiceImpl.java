...
@Service
public class KnowledgeAssociationServiceImpl implements KnowledgeAssociationService {

    private static final Logger log = LoggerFactory.getLogger(KnowledgeAssociationServiceImpl.class);
